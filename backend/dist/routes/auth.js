 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get('/me', auth_1.authenticate, (0, express_async_handler_1.default)(authController.getCurrentUser));
/**
 * @swagger
 * /api/auth/refresh:
 *   post:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/refresh', (0, express_async_handler_1.default)(authController.refreshToken));
/**
 * @swagger
 ...
 */
router.post('/reset-password', (0, express_async_handler_1.default)(authController.resetPassword));
